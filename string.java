...
public class string
{
    public static void main(String args[]){
        ...
        if(verbo.endsWith("ar")){
            ...
            System.out.println("O verbo " + troca.toUpperCase()+verbo.substring(1) +" possui: "+verbo.length() + " caracteres."); //duas formas de exibir a primeira letra maiscular (essa a mais "dificil", a de baixo a mais facil
            System.out.println("O verbo " + verbo.substring(0,1).toUpperCase()+verbo.substring(1) +" possui: "+verbo.length() + " caracteres.");}//mostra a primeira letra em maiscula e quantos caracteres a palavra tem
            ...
            System.out.println("O verbo " + troca.toUpperCase()+verbo.substring(1) +" possui: "+verbo.length() + " caracteres.");
            System.out.println("O verbo " + verbo.substring(0,1).toUpperCase()+verbo.substring(1) +" possui: "+verbo.length() + " caracteres.");} //mostra quantos caracteres o verbo possui
